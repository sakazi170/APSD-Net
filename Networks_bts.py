...
from modules.FLGFA import FLGFA
from modules.CMBF import CMBF
...
class Decoder(nn.Module):
    ...
    def __init__(self, num_classes=4):
        ...
        # Stage 4: 256 (fused) + 256 (f4 skip) → 128
...
class BTS_flair(nn.Module):
    ...
    def forward(self, t1, t1ce, t2, flair):
        ...
        g1, g2, g3, g4 = self.auxiliary_encoder(t1, t1ce, t2)
        f0, f1, f2, f3, f4 = self.leading_encoder(flair, g1=g1, g2=g2, g3=g3)
        bottleneck_fused = self.cmbf(f_local=f4, f_global=g4)
        output = self.decoder(bottleneck_fused, f0, f1, f2, f3)
        return output

class BTS_t1ce(nn.Module):
    ...
    def forward(self, t1, t1ce, t2, flair):
        ...
        g1, g2, g3, g4 = self.auxiliary_encoder(t1, t2, flair)
        f0, f1, f2, f3, f4 = self.leading_encoder(t1ce, g1=g1, g2=g2, g3=g3)
        bottleneck_fused = self.cmbf(f_local=f4, f_global=g4)
        output = self.decoder(bottleneck_fused, f0, f1, f2, f3)
...
class BTS_t1(nn.Module):
    ...
    def forward(self, t1, t1ce, t2, flair):
        ...
        g1, g2, g3, g4 = self.auxiliary_encoder(t1ce, t2, flair)
        f0, f1, f2, f3, f4 = self.leading_encoder(t1, g1=g1, g2=g2, g3=g3)
        bottleneck_fused = self.cmbf(f_local=f4, f_global=g4)
        output = self.decoder(bottleneck_fused, f0, f1, f2, f3)
        return output
...
def test_model():
    ...
    num_classes = 4
    model = BTS_t2(128,128,128, in_channels=1, num_classes=num_classes)
